...
| Model routing and failure | T13, T14, T21 | Provider-neutral gateway tests; bounded retry/fallback/degradation tests; two offline policy scenarios | Mock evaluation is not live-model quality evidence; two timing debts remain |
...
| Kubernetes deployment | T19 | Helm lint/template/schema/kubeconform and 38-resource disposable k3s install/upgrade/rollback | Public VM/DNS/CA and live AWS were not proven |
