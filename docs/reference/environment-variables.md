...
| Models | `LLM_MODEL`, `EMBEDDING_MODEL`, `EMBEDDING_DIM`, `RERANK_MODEL`, `REWRITE_MODEL`, `RERANK_TIMEOUT`, `REWRITE_TIMEOUT`, `REWRITE_CACHE_TTL_SECONDS`, `FASTEMBED_CACHE_PATH`, `MODEL_GATEWAY_DEFAULT_TIMEOUT_SECONDS` |
| Model failure policy | `MODEL_FAILURE_MAX_ATTEMPTS_PER_CANDIDATE`, `MODEL_FAILURE_MAX_TOTAL_ATTEMPTS`, `MODEL_FAILURE_TOTAL_DEADLINE_SECONDS`, `MODEL_FAILURE_BASE_BACKOFF_SECONDS`, `MODEL_FAILURE_MAX_BACKOFF_SECONDS`, `MODEL_FAILURE_JITTER_RATIO`, `MODEL_FAILURE_RETRY_AFTER_MAX_SECONDS`, `MODEL_FAILURE_CIRCUIT_FAILURE_THRESHOLD`, `MODEL_FAILURE_CIRCUIT_OPEN_SECONDS`, `MODEL_FAILURE_CIRCUIT_HALF_OPEN_PROBE_SECONDS`, `MODEL_FAILURE_DEGRADATION_MODE`, `MODEL_FAILURE_SAFE_STATIC_RESPONSE`, `MODEL_FAILURE_RETRY_INVALID_RESPONSE` |
