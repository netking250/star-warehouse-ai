...
| Routes and shell    | `@frontend/src/apps/admin/App.tsx`, `@frontend/src/apps/admin/components/AdminLayout.tsx` | Current capability-gated admin routes and shared console shell.                                                                                                                                                          |
...
| Shared Admin UI     | `@frontend/src/apps/admin/components/AdminPrimitives.tsx`                                 | Active-route page headers, panels, metrics, statuses, filters, and table shell                                                                                                                                           |
...
- Active Admin routes share `PageHeader`, `DataPanel`, `MetricCard`, `StatusBadge`, `FilterBar`, and `DataTableShell`; use semantic theme tokens and keep operational tables horizontally scrollable at constrained widths.
